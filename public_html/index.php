...
<html lang="en">
   ...
   <body>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="container">
                        ...
                        <p class="banner_text">With NRU Phonebook, finding the right contact is quick and hassle-free. My powerful search functionality allows you to locate any contact with ease. Simply type in a name, number, or any relevant information, and let my intelligent search algorithm deliver accurate results in an instant.</p>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        ...
                        <p class="banner_text">Experience seamless accessibility with NRU Phonebook. Whether you're using a smartphone, tablet, or computer, my phonebook is fully optimized for any device. Stay connected no matter where you are, ensuring that important contacts are always within your reach.</p>
                        <div class="read_bt"><a href="phonebook.php">Create Now</a></div>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <div class="container">
                        ...
                        <p class="banner_text">NRU Phonebook takes pride in its simplicity. My user-friendly interface makes navigating and managing your phonebook a breeze. With a clean and intuitive design, you can easily add, edit, or delete contacts with just a few taps and embrace a phonebook that prioritizes ease of use and straightforward functionality.</p>
                        <div class="read_bt"><a href="phonebook.php">Create Now</a></div>
                     </div>
                  </div>
               </div>
      ...
      <div id="contacts" class="services_section layout_padding">
         <div class="container">
...
I am thrilled to embark on this journey as a software engineer and contribute my skills to the ever-evolving world of technology. If you have any inquiries or would like to discuss potential collaborations, feel free to get in touch. Let's create something remarkable together!</p>
                     <div class="readmore_bt"><a href="#more">Read More</a></div>
                  </div>
               </div>
...
-->   
      ...
      <div class="client_section layout_padding">
         <div class="container">
            <h1 id="more" class="client_taital">The Developer</h1>
      ...
      <div class="choose_section layout_padding">
         <div class="container">
            ...
            <div class="newsletter_box">
               ...
               <div class="getquote_bt"><a href="phonebook.php">Create</a></div>
            </div>
         </div>
      </div>
      <!-- choose section end -->
