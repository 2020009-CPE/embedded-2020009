window.onload = function() {
  ...
  // Sort contacts by last name
    ...
    if (nameA < nameB) {
      ...
      // If last names are the same, compare next letters of last names
      const nextLetterA = a.last_name[a.last_name.length - 1].toUpperCase();
      const nextLetterB = b.last_name[b.last_name.length - 1].toUpperCase();
      return nextLetterA.localeCompare(nextLetterB);
    }
  });
